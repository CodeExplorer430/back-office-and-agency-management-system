...
<section class="ct2-panel ct2-action-panel">
    <div class="ct2-section-header">
        <div>
            ...
            <p class="ct2-subtle">Create and update agent records through focused modal workflows so the page stays centered on active rosters and assignments.</p>
        </div>
    </div>
    <div class="ct2-action-grid">
        <button class="ct2-btn ct2-btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-agent-form-modal">Register Agent</button>
        <button class="ct2-btn ct2-btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-agent-assignment-modal">Assign Staff</button>
    </div>
</section>

<?php require CT2_VIEW_PATH . '/partials/ct2_tab_nav.php'; ?>

<?php if ($ct2ActiveTab === 'agents'): ?>
    <section class="ct2-panel">
        ...
        <div class="ct2-table-wrap">
            <table class="ct2-table">
                ...
                <tbody>
                <?php foreach ($ct2AgentPages['records'] as $ct2Agent): ?>
                    <tr>
        ...
        <?php $ct2Pagination = $ct2AgentPages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
    </section>
<?php endif; ?>

<?php if ($ct2ActiveTab === 'assignments'): ?>
    <section class="ct2-panel">
        <div class="ct2-section-header">
            <div>
                <h3>Current Assignments</h3>
                <p class="ct2-subtle">Staff allocations remain visible on the page while updates move into a modal workflow.</p>
            </div>
        </div>
        <div class="ct2-table-wrap">
            <table class="ct2-table">
                ...
                <tbody>
                <?php foreach ($ct2AssignmentPages['records'] as $ct2Assignment): ?>
                    <tr>
        ...
        <?php $ct2Pagination = $ct2AssignmentPages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
    </section>
<?php endif; ?>

<div class="modal fade ct2-modal" id="ct2-agent-form-modal" tabindex="-1" aria-labelledby="ct2-agent-form-modal-title" aria-hidden="true" data-ct2-modal-auto-open="<?= $ct2AgentForm !== null ? 'true' : 'false'; ?>">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-agent-form-modal-title"><?= $ct2AgentForm !== null ? 'Update Agent' : 'Register Agent'; ?></h3>
                    <p class="ct2-subtle mb-0">Maintain agency records, support tier, approval state, and external CT1 references.</p>
                </div>
...
<div class="modal fade ct2-modal" id="ct2-agent-assignment-modal" tabindex="-1" aria-labelledby="ct2-agent-assignment-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-agent-assignment-modal-title">Assign Staff To Agent</h3>
                    <p class="ct2-subtle mb-0">Create a staff-to-agent operating assignment without stretching the module page vertically.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
