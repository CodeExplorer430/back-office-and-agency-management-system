<section class="ct2-section">
    <div class="ct2-section-header">
        <div>
            <p class="ct2-eyebrow">CT2 Module Placeholder</p>
...
<section class="ct2-grid-2">
    ...
    <article class="ct2-panel">
        <h3>Reserved Integration Contract</h3>
        <ul class="ct2-checklist">
            <li>All future endpoints remain `ct2_` prefixed.</li>
            <li>Shared IDs will reference external system ownership where applicable.</li>
            <li>The route scaffold is intentionally ready for the next CT2 feature branch.</li>
        </ul>
