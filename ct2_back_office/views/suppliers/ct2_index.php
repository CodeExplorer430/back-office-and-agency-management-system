<?php
$ct2SupplierForm = $ct2SupplierForEdit ?? null;
$ct2Tabs = [
    'directory' => 'Directory',
    'contracts' => 'Contracts',
    'performance' => 'Performance',
];
$ct2CompletedAt = trim((string) ($ct2OnboardingForSelectedSupplier['completed_at'] ?? ''));
$ct2CompletedDate = $ct2CompletedAt !== '' ? date('Y-m-d', strtotime($ct2CompletedAt)) : '';
$ct2CompletedTime = $ct2CompletedAt !== '' ? date('H:i', strtotime($ct2CompletedAt)) : '';
?>
...
<section class="ct2-panel ct2-action-panel">
    <div class="ct2-section-header">
        <div>
            ...
            <p class="ct2-subtle">Supplier master data and downstream onboarding workflows now open in focused modals so the page stays centered on supplier state and records.</p>
        </div>
    </div>
    <div class="ct2-action-grid">
        <button class="ct2-btn ct2-btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-supplier-form-modal">Supplier Profile</button>
        <button class="ct2-btn ct2-btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-supplier-onboarding-modal">Onboarding Tracker</button>
        <button class="ct2-btn ct2-btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-supplier-contract-modal">Register Contract</button>
        <button class="ct2-btn ct2-btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-supplier-kpi-modal">KPI Scorecard</button>
        <button class="ct2-btn ct2-btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#ct2-supplier-note-modal">Relationship Note</button>
    </div>
</section>
...
<section class="ct2-grid-2">
    ...
    <article class="ct2-panel">
        <h3>Current Supplier Context</h3>
        <p class="ct2-subtle">
            <?= $ct2SelectedSupplierId > 0 ? 'Supplier-specific modal forms will preselect the current supplier and any stored onboarding state.' : 'Choose a supplier in the modal forms to continue onboarding, contract, KPI, and relationship workflows.'; ?>
        </p>
        <ul class="ct2-checklist">
            <li>Supplier directory remains visible for scanning and edit entry points.</li>
            <li>Contract, KPI, and note forms stay shorter by opening only when needed.</li>
            <li>Edit links still deep-link and auto-open the supplier profile modal.</li>
        </ul>
    </article>
</section>
    ...
    <section class="ct2-panel">
        ...
        <div class="ct2-table-wrap">
            <table class="ct2-table">
                ...
                <tbody>
                <?php foreach ($ct2SupplierPages['records'] as $ct2Supplier): ?>
                    <tr>
        ...
        <?php $ct2Pagination = $ct2SupplierPages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
    </section>
<?php endif; ?>

<?php if ($ct2ActiveTab === 'contracts'): ?>
    <section class="ct2-panel">
        ...
        <div class="ct2-table-wrap">
            <table class="ct2-table">
                ...
                <tbody>
                <?php foreach ($ct2ContractPages['records'] as $ct2Contract): ?>
                    <tr>
        ...
        <?php $ct2Pagination = $ct2ContractPages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
    </section>
<?php endif; ?>

<?php if ($ct2ActiveTab === 'performance'): ?>
    <section class="ct2-grid-2">
        <article class="ct2-panel">
            <h3>KPI Snapshot</h3>
            <div class="ct2-table-wrap">
                <table class="ct2-table">
                    ...
                    <tbody>
                    <?php foreach ($ct2KpiPages['records'] as $ct2Kpi): ?>
                        <tr>
            ...
            <?php $ct2Pagination = $ct2KpiPages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
        </article>
        ...
        <article class="ct2-panel">
            ...
            <div class="ct2-table-wrap">
                <table class="ct2-table">
                    ...
                    <tbody>
                    <?php foreach ($ct2RelationshipNotePages['records'] as $ct2Note): ?>
                        <tr>
            ...
            <?php $ct2Pagination = $ct2RelationshipNotePages; require CT2_VIEW_PATH . '/partials/ct2_pagination.php'; ?>
        </article>
    </section>
<?php endif; ?>

<div class="modal fade ct2-modal" id="ct2-supplier-form-modal" tabindex="-1" aria-labelledby="ct2-supplier-form-modal-title" aria-hidden="true" data-ct2-modal-auto-open="<?= $ct2SupplierForm !== null ? 'true' : 'false'; ?>">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-supplier-form-modal-title"><?= $ct2SupplierForm !== null ? 'Update Supplier Record' : 'Register Supplier'; ?></h3>
                    <p class="ct2-subtle mb-0">Maintain supplier master data, operational category, and risk/approval settings.</p>
                </div>
            ...
            <div class="modal-body">
                <form method="post" action="<?= htmlspecialchars(ct2_url(['module' => 'suppliers', 'action' => 'save']), ENT_QUOTES, 'UTF-8'); ?>" class="ct2-form ct2-form-grid">
                    ...
                    <input class="ct2-input" name="contact_role_title" value="<?= htmlspecialchars((string) ($ct2SupplierForm['contact_role_title'] ?? 'Account Manager'), ENT_QUOTES, 'UTF-8'); ?>">
...
<div class="modal fade ct2-modal" id="ct2-supplier-onboarding-modal" tabindex="-1" aria-labelledby="ct2-supplier-onboarding-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-supplier-onboarding-modal-title">Onboarding Tracker</h3>
                    <p class="ct2-subtle mb-0">Track checklist, document, and compliance state for the selected supplier context.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="<?= htmlspecialchars(ct2_url(['module' => 'suppliers', 'action' => 'saveOnboarding']), ENT_QUOTES, 'UTF-8'); ?>" class="ct2-form">
                    ...
                    <label class="ct2-label">Completed Date</label>
                    <input class="ct2-input" name="completed_at_date" type="date" value="<?= htmlspecialchars($ct2CompletedDate, ENT_QUOTES, 'UTF-8'); ?>">
                    <label class="ct2-label">Completed Time</label>
                    <input class="ct2-input" name="completed_at_time" type="time" value="<?= htmlspecialchars($ct2CompletedTime, ENT_QUOTES, 'UTF-8'); ?>">
...
<div class="modal fade ct2-modal" id="ct2-supplier-contract-modal" tabindex="-1" aria-labelledby="ct2-supplier-contract-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-supplier-contract-modal-title">Contract Register</h3>
                    <p class="ct2-subtle mb-0">Capture supplier contract metadata and renewal state without extending the supplier page.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade ct2-modal" id="ct2-supplier-kpi-modal" tabindex="-1" aria-labelledby="ct2-supplier-kpi-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-supplier-kpi-modal-title">KPI Scorecard</h3>
                    <p class="ct2-subtle mb-0">Record weighted supplier performance metrics from a dedicated modal flow.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade ct2-modal" id="ct2-supplier-note-modal" tabindex="-1" aria-labelledby="ct2-supplier-note-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h3 class="modal-title" id="ct2-supplier-note-modal-title">Relationship Note</h3>
                    <p class="ct2-subtle mb-0">Capture supplier relationship updates without keeping a long note form embedded in the main page.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
