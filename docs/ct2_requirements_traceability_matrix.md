...
- `docs/ct2_codebase_audit_2026-03-25.md`
- `docs/ct2_release_summary_2026-03-25-r1.md`
...
| --- | --- | --- | --- | --- | --- | --- |
| FR-01 | Users authenticate into CT2 and are restricted by role and permission. | `docs/ct2_manual_qa_pack.md`, `docs/ct2_operator_runbook.md` | `ct2_back_office/config/ct2_bootstrap.php`, `ct2_back_office/controllers/ct2_AuthController.php`, `ct2_back_office/models/ct2_UserModel.php`, `ct2_back_office/api/*` | `docs/ct2_qa_execution_report.md` login, `403`, and `405` results; `docs/ct2_nfr_evidence.md` | Implemented | Browser and API login now rotate the session identifier, and representative API reads and writes now follow the browser-side permission model. |
...
| FR-11 | JSON APIs expose representative read/write CT2 operations. | `docs/ct2_api_validation.md` | `ct2_back_office/api/*`, `ct2_back_office/scripts/ct2_api_post_regression_check.sh` | API validation guide and API POST regression section in `docs/ct2_qa_execution_report.md`; `docs/ct2_nfr_evidence.md` | Implemented | Read and stable write coverage are directly evidenced, including representative non-admin permission denials that now mirror the browser-side module permissions. |
...
## Overall Assessment
- CT2 is broadly implemented and strongly validator-covered for the repo-defined scope, including the March 25, 2026 auth/API hardening batch.
